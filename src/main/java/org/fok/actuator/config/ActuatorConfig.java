...
public class ActuatorConfig {
	...
	// token创建时的手续费
	public static BigInteger token_create_lock_balance = new BigInteger(prop.get("org.brewchain.token.lock.balance", "0"));
	// token增发时的手续费
	public static BigInteger token_mint_lock_balance = new BigInteger(prop.get("org.brewchain.token.mint.balance", "0"));
	// token燃烧时的手续费
	public static BigInteger token_burn_lock_balance = new BigInteger(prop.get("org.brewchain.token.burn.balance", "0"));
	// 合约创建时的手续费
	public static BigInteger contract_create_lock_balance = new BigInteger(prop.get("org.brewchain.contract.lock.balance", "0"));
	// cryptotoken创建时的手续费
	public static BigInteger crypto_token_create_lock_balance = new BigInteger(prop.get("org.brewchain.cryptotoken.lock.balance", "0"));
